...
CREATE TABLE entreprise (
  ...
  CONSTRAINT entreprise_nom_pays_FK FOREIGN KEY (nom_pays) REFERENCES pays (nom_pays)
)ENGINE=InnoDB;
...
CREATE TABLE stage (
  ...
  id_national_entreprise_stage VARCHAR(255) NOT NULL,
  date_publication_stage DATE NOT NULL,
  date_debut_stage DATE NOT NULL,
  duree_jours_stage INT NOT NULL,
  id_national_entreprise INT NOT NULL,
  CONSTRAINT stage_PK PRIMARY KEY (id_stage),
  CONSTRAINT stage_id_national_entreprise_FK FOREIGN KEY (id_national_entreprise) REFERENCES entreprise (id_national_entreprise)
)ENGINE=InnoDB;
